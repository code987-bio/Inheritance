...
class TimeKeeper3(NameKeeper):
    ...
    p1 = NameKeeper("John", "Doe")  # There is no class employee. Therefore, this won't compile when you will run your code. Replace with Namekeeper?
...
# Class invocation
p1 = Timekeeper3("Joe", "Doe", date, time)  I wasn't sure where to put this!
